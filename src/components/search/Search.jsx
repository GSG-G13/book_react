...
class Search extends React.Component {
    ...
    render() {
        return (
            ...
            //     <input type="text" className="searchInput" onChange={(e) => this.setState({ search: e.target.value })} value={this.search} />
...
<input type="text" className="searchInput" placeholder="Enter book name" onChange={(e) => this.setState({ search: e.target.value })} value={this.search} />
            ...
            <button type="submit" className="searchButton" href="#">
                <svg fill="#fff" width="25" height="25" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512">
                    <path
